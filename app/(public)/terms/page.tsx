      ...
      <main className="container mx-auto px-4 py-16 max-w-4xl">
        ...
        <div className="space-y-8 text-foreground">
          <section>
            ...
            <p className="mb-4">
              By accessing and using Ovoxa ("the Service"), you accept and agree
          ...
          <section>
            ...
            <p className="mb-4">
              Ovoxa is a GenAI role-play platform that provides:
            </p>
          ...
          <section>
            ...
            <p className="mb-4">
              ...
              feedback algorithms, and software, are owned by Ovoxa or its
            ...
            <p className="mb-4">
              ...
              submitting User Content, you grant Ovoxa a worldwide,
          ...
          <section>
            ...
            <p className="mb-4">
              The feedback and analysis provided by Ovoxa is generated by
          ...
          <section>
            ...
            <p className="mb-4">
              ...
              accordance with the laws of the jurisdiction in which Ovoxa
